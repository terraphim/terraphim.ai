+++
title = "Command Rewriting How-To"
description = "Rewrite shell commands (npm install -> bun add, pip install -> uv add) via terraphim-agent's knowledge graph and a tool-execution hook"
date = 2026-04-15
