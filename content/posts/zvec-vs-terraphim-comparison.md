...
tags = ["Terraphim", "vector-search", "knowledge-graph", "semantic-search", "comparison"]
[extra]
toc = true
comments = true
+++
...
- zvec GitHub: [github.com/alibaba/zvec](https://github.com/alibaba/zvec)
- Terraphim Documentation: [terraphim.ai/docs](https://terraphim.ai/docs)
- Proxima (Alibaba's Vector Engine): [github.com/alibaba/proxima](https://github.com/alibaba/proxima)

---

*Have you used zvec or Terraphim? We would love to hear about your experiences on [GitHub Issues](https://github.com/terraphim/terraphim-ai/issues).*
