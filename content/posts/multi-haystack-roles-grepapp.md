...
tags = ["Terraphim", "release", "features", "grepapp", "haystack", "code-search"]
[extra]
toc = true
comments = true
+++
...
- How you have used it elsewhere in your codebase (local)
...
3. **Enhanced ranking**:
   ...
   - Personalised ranking per engineer
...
- Discussions: [github.com/terraphim/terraphim-ai/issues](https://github.com/terraphim/terraphim-ai/issues)

---

**Related Reading:**
- [Native Hook Support: terraphim-agent Learns from Mistakes](/posts/native-hook-support)
- [Learning via Negativa](/posts/learning-via-negativa)
